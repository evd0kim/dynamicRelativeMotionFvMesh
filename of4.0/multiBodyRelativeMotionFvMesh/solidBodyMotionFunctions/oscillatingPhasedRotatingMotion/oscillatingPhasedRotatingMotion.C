...
#include "oscillatingPhasedRotatingMotion.H"
...
{
    defineTypeNameAndDebug(oscillatingPhasedRotatingMotion, 0);
...
bool Foam::solidBodyMotionFunctions::oscillatingPhasedRotatingMotion::read
(
    const dictionary& SBMFCoeffs
)
{
    ...
    SBMFCoeffs_.lookup("phase") >> phase_;
    return true;
}
